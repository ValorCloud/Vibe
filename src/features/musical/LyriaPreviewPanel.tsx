...
export const LyriaPreviewPanel: React.FC<LyriaPreviewPanelProps> = ({
  ...
  // Truncate badge display values to prevent overflow
    ...
    <Card style={{ padding: tokens.spacingVerticalL, gap: tokens.spacingVerticalM, display: 'flex', flexDirection: 'column', background: tokens.colorNeutralBackground2 }}>
      ...
      <div
        style={{
          ...
          // Prevent container from overflowing its card parent
          minWidth: 0,
          overflow: 'hidden',
        }}
      >
        ...
        {/* Lyria compiled prompt preview — readable, no overflow */}
        {hasVisibleParams && styleString && (
          <div
            style={{
